...
var render = function(time) {
    ...
    for(let i=0;i<cubes.length;i++) {
        ...
        //let normalized = pos.normalize().multiplyScalar(0.1);
        cubes[i].position.copy(pos.multiplyScalar(1.04));
        //cubes[i].scale.copy(cubes[i].scale.multiply(new THREE.Vector3(1,1,0.99)));
    ...
    //line.rotation.z = Math.sin(clock.getElapsedTime());
    camera.position.z = 200 + 100 * Math.sin(clock.getElapsedTime()*1);

    //line.position.z = 50 + 20 * Math.sin(clock.getElapsedTime() * 2);
